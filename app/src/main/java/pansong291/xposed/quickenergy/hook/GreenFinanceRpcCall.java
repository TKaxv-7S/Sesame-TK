...
public class GreenFinanceRpcCall {
    ...
    public static String batchSelfCollect(JSONArray bsnIds) {
        return ApplicationHook.request("com.alipay.mcaplatformunit.common.mobile.service.GreenFinancePointCollectService.batchSelfCollect",
