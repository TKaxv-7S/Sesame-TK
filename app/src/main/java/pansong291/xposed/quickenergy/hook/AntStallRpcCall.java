...
public class AntStallRpcCall {
    ...
    public static String home() {
        return ApplicationHook.request("com.alipay.antstall.self.home",
    ...
    public static String settle(String assetId, int settleCoin) {
        return ApplicationHook.request("com.alipay.antstall.self.settle",
    ...
    public static String shopList() {
        return ApplicationHook.request("com.alipay.antstall.shop.list",
                "[{\"freeTop\":false,\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" +
                        VERSION + "\"}]");
    }

    public static String preOneKeyClose() {
        return ApplicationHook.request("com.alipay.antstall.user.shop.close.preOneKey",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\""
                        + VERSION + "\"}]");
    }

    public static String oneKeyClose() {
        return ApplicationHook.request("com.alipay.antstall.user.shop.oneKeyClose",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\""
                        + VERSION + "\"}]");
    }

    public static String preShopClose(String shopId, String billNo) {
        return ApplicationHook.request("com.alipay.antstall.user.shop.close.pre",
    ...
    public static String shopClose(String shopId) {
        return ApplicationHook.request("com.alipay.antstall.user.shop.close",
                "[{\"shopId\":\"" + shopId + "\",\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String oneKeyOpen() {
        return ApplicationHook.request("com.alipay.antstall.user.shop.oneKeyOpen",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\""
                        + VERSION + "\"}]");
    }

    public static String shopOpen(String friendSeatId, String friendUserId, String shopId) {
        return ApplicationHook.request("com.alipay.antstall.user.shop.open",
    ...
    public static String rankCoinDonate() {
        return ApplicationHook.request("com.alipay.antstall.rank.coin.donate",
                "[{\"source\":\"ANTFARM\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }
    public static String friendHome(String userId) {
        return ApplicationHook.request("com.alipay.antstall.friend.home",
    ...
    public static String taskList() {
        return ApplicationHook.request("com.alipay.antstall.task.list",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" +
                        VERSION + "\"}]");
    }

    public static String signToday() {
        return ApplicationHook.request("com.alipay.antstall.sign.today",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" +
                        VERSION + "\"}]");
    }
    ...
    public static String taskFinish(String taskType) {
        return ApplicationHook.request("com.alipay.antstall.task.finish",
    ...
    public static String taskAward(String amount, String prizeId, String taskType) {
        return ApplicationHook.request("com.alipay.antstall.task.award",
    ...
    public static String taskBenefit() {
        return ApplicationHook.request("com.alipay.antstall.task.benefit",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" +
                        VERSION + "\"}]");
    }

    public static String collectManure() {
        return ApplicationHook.request("com.alipay.antstall.manure.collectManure",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" +
                        VERSION + "\"}]");
    }

    public static String queryManureInfo() {
        return ApplicationHook.request("com.alipay.antstall.manure.queryManureInfo",
                "[{\"queryManureType\":\"ANTSTALL\",\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" +
                        VERSION + "\"}]");
    }

    public static String projectList() {
        return ApplicationHook.request("com.alipay.antstall.project.list",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String projectDetail(String projectId) {
        return ApplicationHook.request("com.alipay.antstall.project.detail",
                "[{\"projectId\":\"" + projectId +
                        "\",\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String projectDonate(String projectId) {
        return ApplicationHook.request("com.alipay.antstall.project.donate",
                "[{\"bizNo\":\"" + UUID.randomUUID().toString() + "\",\"projectId\":\"" + projectId +
                        "\",\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String roadmap() {
        return ApplicationHook.request("com.alipay.antstall.village.roadmap",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String nextVillage() {
        return ApplicationHook.request("com.alipay.antstall.user.ast.next.village",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String rankInviteRegister() {
        return ApplicationHook.request("com.alipay.antstall.rank.invite.register",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\""
                        + VERSION + "\"}]");
    }

    public static String friendInviteRegister(String friendUserId) {
        return ApplicationHook.request("com.alipay.antstall.friend.invite.register",
    ...
    public static String shareP2P() {
        return ApplicationHook.request("com.alipay.antiep.shareP2P",
    ...
    public static String achieveBeShareP2P(String shareId) {
        return ApplicationHook.request("com.alipay.antiep.achieveBeShareP2P",
    ...
    public static String shopSendBackPre(String billNo, String seatId, String shopId, String shopUserId) {
        return ApplicationHook.request("com.alipay.antstall.friend.shop.sendback.pre",
    ...
    public static String shopSendBack(String seatId) {
        return ApplicationHook.request("com.alipay.antstall.friend.shop.sendback",
                "[{\"seatId\":\"" + seatId
                        + "\",\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\""
                        + VERSION + "\"}]");
    }
    ...
    public static String rankInviteOpen() {
        return ApplicationHook.request("com.alipay.antstall.rank.invite.open",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\""
                        + VERSION + "\"}]");
    }

    public static String oneKeyInviteOpenShop(String friendUserId, String mySeatId) {
        return ApplicationHook.request("com.alipay.antstall.user.shop.oneKeyInviteOpenShop",
    ...
    public static String dynamicLoss() {
        return ApplicationHook.request("com.alipay.antstall.dynamic.loss",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String throwManure(JSONArray dynamicList) {
        return ApplicationHook.request("com.alipay.antstall.manure.throwManure",
    ...
    public static String settleReceivable() {
        return ApplicationHook.request("com.alipay.antstall.self.settle.receivable",
                "[{\"source\":\"ch_appcenter__chsub_9patch\",\"systemType\":\"android\",\"version\":\"" 
                        + VERSION + "\"}]");
    }
}
