...
public class ConsumeGoldRpcCall {
    ...
    public static String taskV2Index(String taskSceneCode) {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.taskV2.index",
    ...
    public static String consumeGoldIndex() {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.index",
    ...
    public static String signinCalendar() {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.task.signin.calendar",
                "[{}]");
    }

    public static String openBoxAward() {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.task.openBoxAward",
    ...
    public static String taskV2TriggerSignUp(String taskId) {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.taskV2.trigger",
    ...
    public static String promoTrigger() {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.index.promo.trigger",
                "[{\"appSource\":\"consumeGold\",\"cacheMap\":{},\"clientTraceId\":\""
                        + UUID.randomUUID().toString()
    ...
    public static String advertisement(String outBizNo) {
        return ApplicationHook.request("alipay.mobile.ipsponsorprod.consume.gold.send.promo.advertisement",
                "[{\"appSource\":\"consumeGold\",\"cacheMap\":{},\"clientTraceId\":\""
                        + UUID.randomUUID().toString()
