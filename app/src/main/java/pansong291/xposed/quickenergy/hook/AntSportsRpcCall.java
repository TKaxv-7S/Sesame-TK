...
public class AntSportsRpcCall {
        ...
        public static String queryCoinBubbleModule() {
                return ApplicationHook.request("com.alipay.sportshealth.biz.rpc.sportsHealthHomeRpc.queryCoinBubbleModule",
        ...
        public static String receiveCoinAsset(String assetId, int coinAmount) {
                return ApplicationHook.request("com.alipay.sportshealth.biz.rpc.SportsHealthCoinCenterRpc.receiveCoinAsset",
                                "[{\"assetId\":\"" + assetId
                                                + "\",\"chInfo\":\"" + chInfo
        ...
        public static String queryMyHomePage() {
                return ApplicationHook.request("alipay.antsports.walk.map.queryMyHomePage", "[{\"alipayAppVersion\":\""
        ...
        public static String join(String pathId) {
                return ApplicationHook.request("alipay.antsports.walk.map.join", "[{\"chInfo\":\"" + chInfo
        ...
        public static String openAndJoinFirst() {
                return ApplicationHook.request("alipay.antsports.walk.user.openAndJoinFirst", "[{\"chInfo\":\"" + chInfo
        ...
        public static String go(String day, String rankCacheKey, int stepCount) {
                return ApplicationHook.request("alipay.antsports.walk.map.go", "[{\"chInfo\":\"" + chInfo
        ...
        public static String openTreasureBox(String boxNo, String userId) {
                return ApplicationHook.request("alipay.antsports.walk.treasureBox.openTreasureBox", "[{\"boxNo\":\"" + boxNo
                                + "\",\"chInfo\":\"" + chInfo
        ...
        public static String queryBaseList() {
                return ApplicationHook.request("alipay.antsports.walk.path.queryBaseList", "[{\"chInfo\":\"" + chInfo
                                + "\",\"clientOS\":\"android\",\"features\":[\"DAILY_STEPS_RANK_V2\",\"STEP_BATTLE\",\"CLUB_HOME_CARD\",\"NEW_HOME_PAGE_STATIC\",\"CLOUD_SDK_AUTH\",\"STAY_ON_COMPLETE\",\"EXTRA_TREASURE_BOX\",\"NEW_HOME_PAGE_STATIC\",\"SUPPORT_TAB3\",\"SUPPORT_FLYRABBIT\",\"PROP\",\"PROPV2\",\"ASIAN_GAMES\"]}]");
        }

        public static String queryProjectList(int index) {
                return ApplicationHook.request("alipay.antsports.walk.charity.queryProjectList", "[{\"chInfo\":\"" + chInfo
        ...
        public static String donate(int donateCharityCoin, String projectId) {
                return ApplicationHook.request("alipay.antsports.walk.charity.donate", "[{\"chInfo\":\"" + chInfo
        ...
        public static String queryWalkStep() {
                return ApplicationHook.request("alipay.antsports.walk.user.queryWalkStep", "[{\"chInfo\":\"" + chInfo
        ...
        public static String walkDonateSignInfo(int count) {
                return ApplicationHook.request("alipay.charity.mobile.donate.walk.walkDonateSignInfo",
        ...
        public static String donateWalkHome(int count) {
                return ApplicationHook.request("alipay.charity.mobile.donate.walk.home",
                                "[{\"module\":\"3\",\"steps\":" + count + ",\"timezoneId\":\"" + timeZone + "\"}]");
        }

        public static String exchange(String actId, int count, String donateToken) {
                return ApplicationHook.request("alipay.charity.mobile.donate.walk.exchange",
                                "[{\"actId\":\"" + actId + "\",\"count\":"
        ...
        public static String exchangeSuccess(String exchangeId) {
                ...
                return ApplicationHook.request("alipay.charity.mobile.donate.exchange.success", args1);
        }

        /* 文体中心 */
        public static String userTaskGroupQuery(String groupId) {
                return ApplicationHook.request("alipay.tiyubiz.sports.userTaskGroup.query",
                                "[{\"cityCode\":\"" + cityCode + "\",\"groupId\":\"" + groupId + "\"}]");
        }

        public static String userTaskComplete(String bizType, String taskId) {
                return ApplicationHook.request("alipay.tiyubiz.sports.userTask.complete",
        ...
        public static String userTaskRightsReceive(String taskId, String userTaskId) {
                return ApplicationHook.request("alipay.tiyubiz.sports.userTaskRights.receive",
                                "[{\"taskId\":\"" + taskId + "\",\"userTaskId\":\"" + userTaskId + "\"}]");
        }

        public static String queryAccount() {
                return ApplicationHook.request("alipay.tiyubiz.user.asset.query.account",
                                "[{\"accountType\":\"TIYU_SEED\"}]");
        }

        public static String queryRoundList() {
                return ApplicationHook.request("alipay.tiyubiz.wenti.walk.queryRoundList",
                                "[{}]");
        }

        public static String participate(int bettingPoints, String InstanceId, String ResultId, String roundId) {
                return ApplicationHook.request("alipay.tiyubiz.wenti.walk.participate",
        ...
        public static String pathFeatureQuery() {
                return ApplicationHook.request("alipay.tiyubiz.path.feature.query",
                                "[{\"appId\":\"" + appId
                                                + "\",\"features\":[\"USER_CURRENT_PATH_SIMPLE\"],\"sceneCode\":\"wenti_shijiebei\"}]");
        }

        public static String pathMapJoin(String pathId) {
                return ApplicationHook.request("alipay.tiyubiz.path.map.join",
                                "[{\"appId\":\"" + appId + "\",\"pathId\":\"" + pathId + "\"}]");
        }

        public static String pathMapHomepage(String pathId) {
                return ApplicationHook.request("alipay.tiyubiz.path.map.homepage",
                                "[{\"appId\":\"" + appId + "\",\"pathId\":\"" + pathId + "\"}]");
        }

        public static String stepQuery(String countDate, String pathId) {
                return ApplicationHook.request("alipay.tiyubiz.path.map.step.query",
        ...
        public static String tiyubizGo(String countDate, int goStepCount, String pathId, String userPathRecordId) {
                return ApplicationHook.request("alipay.tiyubiz.path.map.go",
                                "[{\"appId\":\"" + appId + "\",\"countDate\":\"" + countDate
                                                + "\",\"goStepCount\":"
        ...
        public static String rewardReceive(String pathId, String userPathRewardId) {
                return ApplicationHook.request("alipay.tiyubiz.path.map.reward.receive",
