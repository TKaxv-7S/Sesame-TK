...
public class AntOrchardRpcCall {
        ...
        public static String orchardIndex() {
                return ApplicationHook.request("com.alipay.antfarm.orchardIndex",
        ...
        public static String mowGrassInfo() {
                return ApplicationHook.request("com.alipay.antorchard.mowGrassInfo",
        ...
        public static String batchHireAnimalRecommend(String orchardUserId) {
                return ApplicationHook.request("com.alipay.antorchard.batchHireAnimalRecommend",
        ...
        public static String batchHireAnimal(List<String>  recommendGroupList) {
                return ApplicationHook.request("com.alipay.antorchard.batchHireAnimal",
        ...
        public static String extraInfoGet() {
                return ApplicationHook.request("com.alipay.antorchard.extraInfoGet",
                                "[{\"from\":\"entry\",\"requestType\":\"NORMAL\",\"sceneCode\":\"FUGUO\",\"source\":\"ch_appcenter__chsub_9patch\",\"version\":\""
                                                + VERSION + "\"}]");
        }

        public static String extraInfoSet() {
                return ApplicationHook.request("com.alipay.antorchard.extraInfoSet",
        ...
        public static String querySubplotsActivity(String treeLevel) {
                return ApplicationHook.request("com.alipay.antorchard.querySubplotsActivity",
        ...
        public static String triggerSubplotsActivity(String activityId, String activityType, String optionKey) {
                return ApplicationHook.request("com.alipay.antorchard.triggerSubplotsActivity",
        ...
        public static String receiveOrchardRights(String activityId, String activityType) {
                return ApplicationHook.request("com.alipay.antorchard.receiveOrchardRights",
                                "[{\"activityId\":\"" + activityId + "\",\"activityType\":\"" + activityType
                                                + "\",\"requestType\":\"NORMAL\",\"sceneCode\":\"ORCHARD\",\"source\":\"ch_appcenter__chsub_9patch\",\"version\":\""
                                                + VERSION + "\"}]");
        }
        ...
        public static String drawLottery() {
                return ApplicationHook.request("com.alipay.antorchard.drawLottery",
        ...
        public static String orchardSyncIndex() {
                return ApplicationHook.request("com.alipay.antorchard.orchardSyncIndex",
        ...
        public static String orchardSpreadManure(String wua) {
                return ApplicationHook.request("com.alipay.antfarm.orchardSpreadManure",
        ...
        public static String orchardListTask() {
                return ApplicationHook.request("com.alipay.antfarm.orchardListTask",
        ...
        public static String orchardSign() {
                return ApplicationHook.request("com.alipay.antfarm.orchardSign",
        ...
        public static String triggerTbTask(String taskId, String taskPlantType) {
                return ApplicationHook.request("com.alipay.antfarm.triggerTbTask",
        ...
        public static String orchardSelectSeed() {
                return ApplicationHook.request("com.alipay.antfarm.orchardSelectSeed",
        ...
        public static String queryGameCenter() {
                return ApplicationHook.request("com.alipay.antorchard.queryGameCenter",
                                "[{\"requestType\":\"NORMAL\",\"sceneCode\":\"ORCHARD\",\"source\":\"ch_appcenter__chsub_9patch\",\"version\":\""
                                                + VERSION + "\"}]");
        }

        public static String noticeGame(String appId) {
                return ApplicationHook.request("com.alipay.antorchard.noticeGame",
                                "[{\"appId\":\"" + appId
                                                + "\",\"requestType\":\"NORMAL\",\"sceneCode\":\"ORCHARD\",\"source\":\"ch_appcenter__chsub_9patch\",\"version\":\""
                                                + VERSION + "\"}]");
        }
        ...
        public static String submitUserAction(String gameId) {
                return ApplicationHook.request("com.alipay.gamecenteruprod.biz.rpc.v3.submitUserAction",
        ...
        public static String submitUserPlayDurationAction(String gameAppId, String source) {
                return ApplicationHook.request("com.alipay.gamecenteruprod.biz.rpc.v3.submitUserPlayDurationAction",
                                "[{\"gameAppId\":\"" + gameAppId + "\",\"playTime\":32,\"source\":\"" + source
                                                + "\",\"statisticTag\":\"\"}]");
        }

        public static String smashedGoldenEgg() {
                return ApplicationHook.request("com.alipay.antorchard.smashedGoldenEgg",
