...
public class ConfigV2 {
    ...
    public static final ConfigV2 INSTANCE = defInit();
    ...
    /* forest */
    private boolean collectEnergy = false;

    private boolean collectWateringBubble = true;

    private boolean batchRobEnergy = false;
    private boolean collectProp = true;
    private boolean limitCollect = true;
    private int limitCount = 50;
    private boolean doubleCard = false;
    private List<String> doubleCardTime = new ArrayList<>();
    //TODO 继续
    ...
    public static ConfigV2 defInit() {
    ...
    public static int tmpStepCount() {
        ...
        tmpStepCount = ConfigV2.INSTANCE.getSyncStepCount();
        if (tmpStepCount > 0) {
